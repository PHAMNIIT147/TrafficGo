...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "vehicle speed estimation and error detection"))
        ...
        self.actionSynchronizeStreams.setText(
            _translate("MainWindow", "Synchronize streams"))
        self.actionScaleToFitFrame.setText(
            _translate("MainWindow", "Scale to fit frame"))
        self.actionFullScreen.setText(
            _translate("MainWindow", "Full Screen(&F)"))
