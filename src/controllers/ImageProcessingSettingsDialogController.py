...
class ImageProcessingSettingsDialogController(QDialog, Ui_ImageProcessingSettingsDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.resetAllToDefaultsButton.released.connect(
            self.resetAllDialogToDefaults)
        self.resetSmoothToDefaultsButton.released.connect(
            self.resetSmoothDialogToDefaults)
        self.resetDilateToDefaultsButton.released.connect(
            self.resetDilateDialogToDefaults)
        self.resetErodeToDefaultsButton.released.connect(
            self.resetErodeDialogToDefaults)
        self.resetFlipToDefaultsButton.released.connect(
            self.resetFlipDialogToDefaults)
        self.resetCannyToDefaultsButton.released.connect(
    ...
    def updateStoredSettingsFromDialog(self):
        ...
        self.imageProcessingSettings.smoothParam1 = int(
            self.smoothParam1Edit.text())
        self.imageProcessingSettings.smoothParam2 = int(
            self.smoothParam2Edit.text())
        self.imageProcessingSettings.smoothParam3 = float(
            self.smoothParam3Edit.text())
        self.imageProcessingSettings.smoothParam4 = float(
            self.smoothParam4Edit.text())
        # Dilate
        self.imageProcessingSettings.dilateNumberOfIterations = int(
            self.dilateIterationsEdit.text())
        # Erode
        self.imageProcessingSettings.erodeNumberOfIterations = int(
            self.erodeIterationsEdit.text())
        # Flip
        if self.flipCodeGroup.checkedButton() == self.flipXAxisButton:
            ...
            self.imageProcessingSettings.flipCode = -1
        # Canny
        self.imageProcessingSettings.cannyThreshold1 = float(
            self.cannyThresh1Edit.text())
        self.imageProcessingSettings.cannyThreshold2 = float(
            self.cannyThresh2Edit.text())
        self.imageProcessingSettings.cannyApertureSize = int(
            self.cannyApertureSizeEdit.text())
    ...
    def updateDialogSettingsFromStored(self):
        ...
        self.smoothParam1Edit.setText(
            str(self.imageProcessingSettings.smoothParam1))
        self.smoothParam2Edit.setText(
            str(self.imageProcessingSettings.smoothParam2))
        self.smoothParam3Edit.setText(
            str(self.imageProcessingSettings.smoothParam3))
        self.smoothParam4Edit.setText(
            str(self.imageProcessingSettings.smoothParam4))
        # Dilate
        self.dilateIterationsEdit.setText(
            str(self.imageProcessingSettings.dilateNumberOfIterations))
        # Erode
        self.erodeIterationsEdit.setText(
            str(self.imageProcessingSettings.erodeNumberOfIterations))
        # Flip
        ...
        # Canny
        self.cannyThresh1Edit.setText(
            str(self.imageProcessingSettings.cannyThreshold1))
        self.cannyThresh2Edit.setText(
            str(self.imageProcessingSettings.cannyThreshold2))
        self.cannyApertureSizeEdit.setText(
            str(self.imageProcessingSettings.cannyApertureSize))
        self.cannyL2NormCheckBox.setChecked(
            self.imageProcessingSettings.cannyL2gradient)
    ...
    def validateDialog(self):
        ...
        if int(self.smoothParam1Edit.text()) % 2 == 0 and int(self.smoothParam1Edit.text()) != 0:
            self.smoothParam1Edit.setText(
                str(int(self.smoothParam1Edit.text()) + 1))
        ...
        if int(self.smoothParam2Edit.text()) % 2 == 0 and int(self.smoothParam2Edit.text()) != 0:
            self.smoothParam2Edit.setText(
                str(int(self.smoothParam2Edit.text()) + 1))
            QMessageBox.information(self.parentWidget(),
                                    "NOTE:",
        ...
        if self.cannyApertureSizeEdit.text().strip() == '':
            self.cannyApertureSizeEdit.setText(
                str(DEFAULT_CANNY_APERTURE_SIZE))
            inputEmpty = True
