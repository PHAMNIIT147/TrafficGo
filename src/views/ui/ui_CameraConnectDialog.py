...
class Ui_CameraConnectDialog(object):
    def setupUi(self, CameraConnectDialog):
        ...
        self.enableFrameProcessingCheckBox = QtWidgets.QCheckBox(
            self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.enableFrameProcessingCheckBox.setFont(font)
        self.enableFrameProcessingCheckBox.setObjectName(
            "enableFrameProcessingCheckBox")
        ...
        self.resetToDefaultsPushButton = QtWidgets.QPushButton(
            self.layoutWidget)
        self.resetToDefaultsPushButton.setObjectName(
            "resetToDefaultsPushButton")
        ...
        self.okCancelBox.setStandardButtons(
        ...
        CameraConnectDialog.setTabOrder(
            self.apiPreferenceComboBox, self.imageBufferSizeEdit)
        CameraConnectDialog.setTabOrder(
            self.imageBufferSizeEdit, self.dropFrameCheckBox)
        CameraConnectDialog.setTabOrder(
            self.dropFrameCheckBox, self.capturePrioComboBox)
        CameraConnectDialog.setTabOrder(
            self.capturePrioComboBox, self.processingPrioComboBox)
        CameraConnectDialog.setTabOrder(
            self.processingPrioComboBox, self.tabLabelEdit)
        CameraConnectDialog.setTabOrder(
            self.tabLabelEdit, self.enableFrameProcessingCheckBox)
        CameraConnectDialog.setTabOrder(
            self.enableFrameProcessingCheckBox, self.resetToDefaultsPushButton)
    ...
    def retranslateUi(self, CameraConnectDialog):
        ...
        self.label_10.setText(_translate(
            "CameraConnectDialog", "[0, 1, 2, ...]"))
        self.filenameRadioButton.setText(
        ...
        self.label_7.setText(_translate(
            "CameraConnectDialog", "Processing Thread:"))
        self.label_8.setText(_translate("CameraConnectDialog", "Tab Label:"))
        self.enableFrameProcessingCheckBox.setText(_translate(
            "CameraConnectDialog", "Enable frame processing"))
        self.resetToDefaultsPushButton.setText(
            _translate("CameraConnectDialog", "Reset to Defaults"))
